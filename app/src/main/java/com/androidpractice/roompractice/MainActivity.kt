...
import com.androidpractice.roompractice.ui.theme.RoomPracticeTheme
...
fun MainScreenPreview() {
    ...
    lateinit var allProductsO: List<Product>
    lateinit var searchResultO: List<Product>
    val owner = LocalViewModelStoreOwner.current?.let {
        val viewModel: MainViewModel = viewModel(
            it,
            "MainViewModel",
        ...
        val allProducts by viewModel.allProducts.observeAsState(listOf())
        val searchResults by viewModel.searchResults.observeAsState(listOf())
        allProductsO = allProducts
        searchResultO = searchResults
        viewModelO = viewModel
    }

    MainScreen(
        allProducts = allProductsO,
        searchResult = searchResultO,
        viewModel = viewModelO
    )
}
